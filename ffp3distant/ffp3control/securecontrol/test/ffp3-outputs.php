...
<html>
					...
					<div id="main">
						 <!-- Featured Post -->
							<article class="post featured">
                                ...
                                <div>
                                    <center>
                                  		<a href="https://iot.olution.info/ffp3/ffp3datas/cronpompe.php" class="button small">cron manuel</a>
                        		        <a href="https://iot.olution.info/ffp3/ffp3datas/cronlog.txt" class="button small">journal du cron</a>
                        		        <br><br>
    ...
    <script>
        ...
        function createOutput(element) {
            ...
            var httpRequestData = "action=output_create&mail="+mail+"&mailNotif="+mailNotif+"&aqThr="+aqThr+"&taThr="+taThr+"&chauff="+chauff+"&bouffeMat="+bouffeMat+"&bouffeMid="+bouffeMid+"&bouffeSoir="+bouffeSoir+"&tempsGros="+tempsGros+"&tempsPetits="+tempsPetits;
