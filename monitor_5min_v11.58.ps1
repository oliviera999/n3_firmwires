#!/usr/bin/env pwsh
# Script de monitoring 5 minutes - ESP32 v11.58
...
$logFile = "monitor_5min_v11.58_$timestamp.log"

Write-Host "=== MONITORING 5 MINUTES - ESP32 v11.58 ===" -ForegroundColor Cyan
