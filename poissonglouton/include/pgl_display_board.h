...
#define PGL_UI_HEADER_LED_GAP 10
#define PGL_UI_BODY_Y (PGL_UI_HEADER_H + 4)
#define PGL_UI_CARD_PAD 6
#define PGL_UI_CARD_RADIUS 8
#define PGL_UI_CARD_GAP 6
#define PGL_UI_COUNTER_CARD_H 140
#define PGL_UI_SENSOR_CARD_H 120
#define PGL_UI_AUDIO_CARD_H 56
...
#define PGL_UI_PAD_Y 6
#define PGL_UI_HEADER_H 40
#define PGL_UI_HEADER_LED_GAP 12
#define PGL_UI_BODY_Y (PGL_UI_HEADER_H + 2)
#define PGL_UI_CARD_PAD 6
#define PGL_UI_CARD_RADIUS 8
#define PGL_UI_CARD_GAP 6
#define PGL_UI_LEFT_W_PCT 52
#define PGL_UI_COUNTER_H_PCT 58
#define PGL_UI_SENSOR_H_PCT 44
