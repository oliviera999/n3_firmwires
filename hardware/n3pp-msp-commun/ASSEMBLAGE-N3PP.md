...
## À laisser VIDE — DNP (48 composants)

| Réf | Valeur | Description | Pourquoi DNP |
|---|---|---|---|
| C2 | 470u/16V | Découplage rail 5V servos | profil msp uniquement |
...
| J10 | JST-XH | DHT INT msp (1=3V3 2=DATA 3=GND) | profil msp uniquement |
| J11 | JST-XH | DHT EXT msp (1=3V3 2=DATA 3=GND) | profil msp uniquement |
| J12 | Bornier_5.08 | Sonde DS18B20 étanche (1=3V3 2=DATA 3=GND) | profil msp uniquement |
| J13 | JST-XH | Capteur pluie — sortie NUMERIQUE DO (1=3V3 2=DO 3=GND) | profil msp uniquement |
| J20 | Header servo | Servo G/D tracker (1=SIG 2=+5V 3=GND) | profil msp uniquement |
| J21 | Header servo | Servo H/B tracker (1=SIG 2=+5V 3=GND) | profil msp uniquement |
...
| R14 | 10k | Bas de pont ADC_A (peupler si LDR ; DNP si capteur AO) | profil msp uniquement |
| R15 | 10k | Bas de pont ADC_B (peupler si LDR ; DNP si capteur AO) | extension optionnelle (AUX / pont LDR) |
| R16 | 10k | Bas de pont ADC_C (peupler si LDR ; DNP si capteur AO) | profil msp uniquement |
| R17 | 10k | Bas de pont ADC_D (peupler si LDR ; DNP si capteur AO) | profil msp uniquement |
| R20 | 220 | Série signal servo G/D (GPIO25) | profil msp uniquement |
| R22 | 10k | Pull-up data DHT INT msp | profil msp uniquement |
| R23 | 10k | Pull-up data DHT EXT msp | profil msp uniquement |
| R24 | 4.7k | Pull-up bus 1-Wire DS18B20 | profil msp uniquement |
| R27 | 220 | Série signal servo H/B (GPIO14) | profil msp uniquement |
