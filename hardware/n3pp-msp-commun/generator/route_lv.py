#!/usr/bin/env python3
"""Routage de la carte commune n3pp + msp — pipeline reproductible (dérivé de route_230v.py).
...
BOARD_PATH = KICAD / "n3pp-msp-commun.kicad_pcb"
...
def add_stitching_vias(b):
    ...
    slots_margin = []
    spots = [(x, y) for x in range(46, 247, 12) for y in range(50, 146, 10)]
    added = 0
    for x, y in spots:
...
def main():
    ...
    ap.add_argument("--jar", default="/root/jars/fr19.jar",
    ...
    print("pipeline carte commune terminé")
