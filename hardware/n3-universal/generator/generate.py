...
def build_components():
    ...
    comps += [
        ...
        dict(ref="J19", sym="CONN_02", value="Bornier_5.08",
             fp="TerminalBlock_bornier-2_P5.08mm",
             desc="Distribution 3V3 capteurs — rail COMMUTE (1=+3V3_SW 2=GND)", sch=(24, 90), pcb=(306, 156, 0),
             nets={"1": "+3V3_SW", "2": "GND"}),
        dict(ref="J20", sym="CONN_06", value="Header alim",
             fp="PinHeader_1x06_P2.54mm_Vertical",
             desc="Rail Dupont (1-2=+5V 3-4=GND 5-6=+3V3_SW)", sch=(24, 98), pcb=(288, 146, 0),
    ...
    comps += [
        ...
        dict(ref="Q7", sym="PMOS_GDS", value="NDP6020P", fp="TO-220-3_Vertical",
             desc="P-MOSFET rail capteurs (1=G 2=D 3=S)", sch=(155, 16), pcb=(228, 104, 0),
    ...
    comps += [
        ...
        dict(ref="Q9", sym="PMOS_DGS", value="BS250", fp="TO-92_Inline",
             desc="P-MOSFET coupure haute du diviseur (1=D 2=G 3=S)", sch=(155, 28), pcb=(218, 112, 0),
             nets={"1": "VBAT_SW", "2": "PDIV_G", "3": "VBAT_SENSE"}),
        dict(ref="Q10", sym="NPN", value="BC337-40", fp="TO-92_Inline",
             desc="Driver diviseur (1=C 2=B 3=E)", sch=(155, 34), pcb=(228, 112, 0),
    ...
    comps += [
        dict(ref="J26", sym="CONN_02", value="Bornier_5.08",
             ...
             sch=(146, 50), pcb=(246, 156, 0),
             nets={"1": "VBAT12_IN", "2": "GND"}),
        dict(ref="Q11", sym="PMOS_DGS", value="NDP6020P", fp="TO-220-3_Vertical",
             desc="Anti-inversion P-MOSFET (1=D=entrée 2=G 3=S=sortie)", sch=(155, 52), pcb=(234, 148, 0),
    ...
    comps += [
        ...
        dict(ref="F1", sym="FUSE", value="T1A 5x20",
             ...
             desc="Fusible entrée secteur du module alim (temporisé 1A)", sch=(155, 78), pcb=(262, 44, 270),
             nets={"1": "MAINS_L", "2": "MAINS_LF"}),
        dict(ref="RV1", sym="VARISTOR", value="10D471K",
             fp="CP_Radial_D10.0mm_P5.00mm",
             desc="Varistance 300VAC transitoires secteur", sch=(155, 82), pcb=(270, 50, 270),
             nets={"1": "MAINS_LF", "2": "MAINS_N"}),
    ...
    for i, (jref, rref, net, x) in enumerate([
            ("J31", "R43", "ADC_A", 172), ("J32", "R44", "ADC_B", 187),
            ("J33", "R45", "ADC_C", 202), ("J34", "R46", "ADC_D", 217)]):
        comps += [
            dict(ref=jref, sym="CONN_03", value="Bornier_5.08",
                 fp="TerminalBlock_bornier-3_P5.08mm",
                 desc=f"Entrée analogique {net} (1=3V3_SW 2=SIG 3=GND) — LDR msp / sonde sol n3pp",
                 sch=(146, 108 + 4 * i), pcb=(x, 156, 0),
    ...
    comps += [
        ...
        dict(ref="J30", sym="CONN_03", value="JST-XH",
             ...
             sch=(126, 124), pcb=(117, 156, 0),
             nets={"1": "+3V3_SW", "2": NET["ULTRASON_TANK"], "3": "GND"}),
        dict(ref="R47", sym="R", value="10k*",
             fp="R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal",
             desc="Pull-up DHT ext (POSER sur unités msp uniquement)", sch=(126, 130), pcb=(128, 150, 0),
    ...
    for i, (hx, hy) in enumerate([(45, 45), (313, 78), (45, 155), (313, 144)], 1):
...
PCB_TEXTS = [
    ...
    (191, 137, "JP SD: 1-2=S3 (defaut) / 2-3=WROOM (env wroom-sd)", 0.8),
    (204, 139, "SD", 1.0),
    (222, 136.5, "BUS 12V: FUSIBLE LAME 7,5-10A EN AMONT OBLIGATOIRE", 0.8),
    (232, 152, "VBAT SENSE", 0.8),
    (246, 152, "12V IN", 0.8),
    (260, 152, "BUCK IN", 0.8),
    (274, 152, "BUCK OUT 5V", 0.8),
    (172, 152, "ADC A", 0.8), (187, 152, "ADC B", 0.8),
    (202, 152, "ADC C", 0.8), (217, 152, "ADC D", 0.8),
    (195, 154.5, "LDR msp (R pose) / SONDE SOL n3pp (sans R)", 0.7, "B.SilkS"),
    (104, 152, "PLUIE msp", 0.8),
    (117, 152, "DHT EXT msp", 0.8),
    (66, 102, "I2C INA/DS3231", 0.8),
    (261.4, 78, "ANTENNE S3: zone degagee", 0.8),
    (252, 42.5, "SECTEUR 230V", 1.0),
    (252, 68, "!! DANGER 230V !!", 1.1),
    (296, 104, "SERVOS", 0.9),
    (312, 115, "SERVICE", 0.8),
