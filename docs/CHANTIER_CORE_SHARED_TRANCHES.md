...
### T3 — L4 : offline-first & stats (nouvelles libs, risque faible si additive) — ✅ T3a LIVRÉ (libs additives + tests ; T3b câblage upload, T3c stats ffp5cs et POST réseau restent à faire)
