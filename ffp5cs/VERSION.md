...
- **Garde-fou budget flash** (`tools/pio_check_flash_budget.py`, post-build) : échoue si l'image dépasse `custom_flash_budget_pct` de la partition app (wroom-test : 70 %). Évite un débordement flash silencieux (partitions prod/S3 serrées).
