#pragma once
// =============================================================================
// FFP5CS — Validation/comparaison d'epoch (anti-overflow 32-bit)
// =============================================================================
// Extrait de power.cpp (audit §3.8) pour tester la logique pure de validation
// d'epoch. POINT CRITIQUE : EPOCH_MAX_VALID (2050) dépasse INT32_MAX, donc la
// comparaison se fait en UNSIGNED pour éviter un overflow sur time_t 32-bit.
// Un bug ici fausse l'acceptation/rejet des horloges NTP/RTC.
//
