...
//
// Hors périmètre (toujours locaux, même si serverCovers == true) :
// - actionneurs (relais chauffage, pompe réserve) ;
// - machine d'état FloodAlert (`inFlood`) : RefillOverfill lit ce flag pour
//   autoriser Unlock — ExitFlood doit tourner hors du gate mails.
//
