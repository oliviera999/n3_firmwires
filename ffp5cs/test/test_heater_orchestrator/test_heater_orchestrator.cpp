...
// Contrat Phase 3 : quand le serveur couvre les mails partagés, l'appelant
// passe mailEnabled=false. Le relais DOIT quand même s'allumer (froid) et
// s'éteindre (trop chaud) — sinon plus aucune régulation en liaison saine.
