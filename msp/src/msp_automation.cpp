...
// régressive). Libellés de réveil passés du FR à l'EN (uniformisation avec
// n3pp/shared) : seul changement observable.
void print_wakeup_reason() {
  ...
  // même ordre, pour une parité stricte (aucun autre changement observable).
