# Monitoring 90s post-flash v11.82 - Phase 3 NVS
# Test des optimisations Phase 3: Rotation automatique des logs et nettoyage

Write-Host "=== MONITORING 90s POST-FLASH v11.82 - PHASE 3 NVS ===" -ForegroundColor Cyan
Write-Host "Version: 11.82" -ForegroundColor Yellow
Write-Host "Phase 3: Rotation automatique des logs et nettoyage" -ForegroundColor Green
Write-Host ""

$port = "COM3"
$baudRate = 115200
$duration = 90
$logFile = "monitor_90s_v11.82_post_flash_$(Get-Date -Format 'yyyy-MM-dd_HH-mm-ss').log"

Write-Host "Configuration:" -ForegroundColor Green
Write-Host "  Port: $port"
Write-Host "  Baud Rate: $baudRate"
Write-Host "  Duree: $duration secondes"
