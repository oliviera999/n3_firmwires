#pragma once
// =============================================================================
// n3_common — Décisions de sommeil (pures)
// =============================================================================
// Mutualisé depuis ffp5cs/include/sleep_decision.h (audit §3.8). Le délai de
// sommeil adaptatif pilote l'autonomie ET la disponibilité (un mauvais délai =
// batterie vidée ou réveils manqués). Logique pure paramétrée par valeurs (pas
// un struct de config) -> aucune dépendance config.h/Arduino.
// =============================================================================
