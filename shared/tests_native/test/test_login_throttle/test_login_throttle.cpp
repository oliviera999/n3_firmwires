...
// Tests de LoginThrottle (n3_login_throttle.h) — anti-brute-force du login web
// local, mutualisé depuis ffp5cs. La logique est PURE et FAIL-SAFE : le temps est
// injecté (nowMs), aucune dépendance matériel. On valide : pas de lockout sous le
// seuil, lockout après N échecs rapprochés, expiration, reset sur succès, fenêtre.
...
// Reset sur succès même APRÈS verrouillage : un login réussi lève le verrou.
