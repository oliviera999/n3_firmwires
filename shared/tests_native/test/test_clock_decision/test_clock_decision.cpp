...
// Tests de ClockDecision (n3_clock_decision.h), mutualisé depuis ffp5cs.
...
static const time_t COMPILE = 1780444800;  // 2026-06-03 00:00:00 (secours)
static const time_t NOW2026 = 1781000000;  // ~2026-06-09
static const time_t FAR2027 = 1800000000;  // 2027, très loin du compile

// Tolérance float pour comparaisons PPM.
...
void test_drift_small_positive_unclamped(void) {
  // Dérive fractionnaire sous la borne (non écrêtée).
...
// ---------------------------------------------------------------------------
// Parité brute-force : transcription INLINE de l'original comparée aux helpers.
// ---------------------------------------------------------------------------
